...
\begin{frame}{About myself}
  \begin{figure}
    ...
    \begin{subfigure}{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth, height=3.5cm]{KristiansandPort.png}
    \end{subfigure}
  \end{figure}
  \begin{itemize}
...
\begin{frame}{Thesis project: Model independent $\gamma$ measurement}
  \begin{itemize}
    ...
    \begin{itemize}
      \item{$D\to K^+K^-\pi^+\pi^-$}
    \end{itemize}
    \item{G. Wilkinson and J. Rademacker \href{https://arxiv.org/abs/hep-ph/0611272}{arXiv:hep-ph/0611272}}
